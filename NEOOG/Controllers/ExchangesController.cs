...
namespace NEOOG.Controllers
{
    public class ExchangesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ExchangeID,ExchangeName,ExchangeGetGive,ExchangeQTY,ExchangePostTime,ExchangeUserName")] Exchange exchange)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ExchangeID,ExchangeName,ExchangeGetGive,ExchangeQTY,ExchangePostTime,ExchangeUserName")] Exchange exchange)
        {
            if (ModelState.IsValid)
            {
